...
#   codex        -- Copy skills to $CODEX_HOME/skills/ (defaults to ~/.codex/skills/)
...
ALL_TOOLS=(claude-code copilot antigravity gemini-cli codex opencode openclaw cursor aider windsurf qwen kimi)
...
install_codex() {
  ...
  warn "Codex: restart Codex to pick up newly installed skills."
}
